...
public enum PluginImage {
  ...
  // Container icons
  IMG_SUBPROCESS_COLLAPSED("subprocess.collapsed", "sub_co.gif"), //$NON-NLS-1$
  IMG_SUBPROCESS_EXPANDED("subprocess.expanded", "sub_sync.gif"), //$NON-NLS-1$
//  IMG_EVENT_SUBPROCESS("event.subprocess", "type.event.subprocess.png"), //$NON-NLS-1$
  IMG_EVENT_SUBPROCESS("event.subprocess", "loop_obj.gif"), //$NON-NLS-1$
