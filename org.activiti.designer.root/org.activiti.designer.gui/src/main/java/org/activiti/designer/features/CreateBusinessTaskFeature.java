...
public class CreateBusinessTaskFeature extends AbstractCreateFastBPMNFeature {
	...
	public CreateBusinessTaskFeature(IFeatureProvider fp) {
	    super(fp, "业务服务", "新增业务服务");
	  }

	public CreateBusinessTaskFeature(IFeatureProvider fp, String name, String description, String customServiceTaskId) {
	...
	public Object[] create(ICreateContext context) {
		...
		newServiceTask.setName("业务服务");
		newServiceTask.setExtensionId(customServiceTaskId);
		newServiceTask.setExtensionId(BUSINESS_TASK);
