...
public class CreateBaseServiceFeature extends AbstractCreateFastBPMNFeature  {
	...
	public CreateBaseServiceFeature(IFeatureProvider fp) {
	    super(fp, "基础服务", "新增基础服务");
	  }

	public CreateBaseServiceFeature(IFeatureProvider fp, String name, String description, String customServiceTaskId) {
	...
	public Object[] create(ICreateContext context) {
		...
		newServiceTask.setExtensionId(BASE_TASK);
