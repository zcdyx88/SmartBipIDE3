...
public class BusiConfigAddWizardPage extends WizardPage {
	 ...
	 * Create the wizard.
	 */
	public BusiConfigAddWizardPage() {
		super("wizardPage");
		setTitle("新增业务服务配置");
		setDescription("新增业务服务配置");
	}
	
	public BusiConfigAddWizardPage(BusiSvcInfo busiSvcInfo){
		super("wizardPage");
		svcInfo = busiSvcInfo;
		setTitle("新增业务服务配置");
		setDescription("新增业务服务配置");
	...
	public void createControl(Composite parent) {
		...
		serviceIDText.setText(this.svcInfo.getId());
		...
		serviceNameText.setText(this.svcInfo.getName());
		...
		configTypeCombo.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				// 因为模型改变了，所以要及时更改界面
				BusiConfigAddWizardPage.this.getContainer().updateButtons();
			}
		});
