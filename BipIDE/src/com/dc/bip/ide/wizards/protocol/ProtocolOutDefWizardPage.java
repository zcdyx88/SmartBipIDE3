...
public class ProtocolOutDefWizardPage extends AWizardPage {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3046749380123332598L;
	private Text text;
	 ...
	 * Create the wizard.
	 */
	public ProtocolOutDefWizardPage() {
		super("wizardPage");
	}
	...
	public void createControl(Composite parent) {
		...
		String  protocolType= ProtocolOutDefWizardPage.this.getWizard().getDialogSettings().get("protocol");  
		if(protocolType!=null && protocolType.equals("TCP")){
			this.setTitle("TCP接出协议");
			this.setDescription("TCP接出协议信息录入");
			...
			String type = "";
			if(ProtocolOutDefWizardPage.this.getWizard().getDialogSettings().get("protocol") != null){
				type=ProtocolOutDefWizardPage.this.getWizard().getDialogSettings().get("protocol");
			}
			...
			text.addModifyListener(new ModifyListener() {
				...
				public void modifyText(ModifyEvent e) {
					...
					ProtocolOutDefWizardPage.this.getContainer().updateButtons();
				}
			});
			...
			this.setTitle("WebService/HTTP接出协议");
			this.setDescription("WebService/HTTP接出协议信息录入");
			...
			combo.addModifyListener(new ModifyListener(){
				...
				public void modifyText(ModifyEvent arg0) {
					Combo combo1 = (Combo)arg0.widget;
					protocolInService.setContactProtocolType(combo1.getText());
					ProtocolOutDefWizardPage.this.getContainer().updateButtons();
				}
