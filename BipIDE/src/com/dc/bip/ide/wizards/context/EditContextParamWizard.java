...
//业务服务向导
public class EditContextParamWizard extends Wizard implements INewWizard {

	private TableItem tableItem;

	public EditContextParamWizard(TableItem tableItem) {
		this.tableItem = tableItem;
	}

	@Override
	public void addPages() {
		this.addPage(new EditContextParamWizardPage(tableItem));
	...
	public boolean performFinish() {
		...
		EditContextParamWizardPage editpage = (EditContextParamWizardPage) pages[0];
		tableItem.setText(0,editpage.getPararmID());
		tableItem.setText(1,editpage.getPararmType());
		tableItem.setText(2,editpage.getPararmValue());
		tableItem.setText(3,editpage.getPararmDesc());
