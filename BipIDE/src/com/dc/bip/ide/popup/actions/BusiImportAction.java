...
public class BusiImportAction implements IObjectActionDelegate {

	private TreeNode treeNode;

	public BusiImportAction() {
	...
	public void run(IAction action) {
		...
		BusiSvcImpWizard bsw = new BusiSvcImpWizard(treeNode.getProjectName());
