...
public class NewProtocolInAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
			...
			ProtocolInWizard bsw = new ProtocolInWizard(treeNode.getProjectName());
	        WizardDialog dialog = new WizardDialog(shell, bsw);
	        dialog.setTitle("新增接入协议");
	        dialog.open();    
	}
