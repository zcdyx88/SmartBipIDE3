...
public class NewBaseSvcAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
			...
			BaseSvcW bsw = new BaseSvcW(treeNode.getProjectName());
	        WizardDialog dialog = new WizardDialog(shell, bsw);
	        dialog.setTitle("新建基础服务");
	        dialog.open();    
	}
