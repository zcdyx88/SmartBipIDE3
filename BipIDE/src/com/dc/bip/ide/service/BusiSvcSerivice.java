...
public class BusiSvcSerivice {
	...
	public static List<BusiSvcInfo> getAll(String projectName){
		...
		String busiPath = project.getFolder("/dev/services/busi/").getLocation().toString();
	...
	public static void main(String[] args){
		String projectPath = BusiSvcSerivice.class.getClass().getResource("/").getFile().toString();
